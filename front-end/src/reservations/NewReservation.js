...
export default function NewReservation({ loadDashboard, edit }) {
  ...
  /**
   * Make an API call to grab all reservations if the form is edited or filled.
   */
  useEffect(() => {
    if (edit) {
  ...
  /**
   * When the form is edited update the state.
   */
  function handleChange({ target }) {
    ...
    /**
   * Ensures all of the fields exist and are filled in correctly.
   */
  ...
  /**
   *  Validates and makes the API call when a form is submited.
   */
  ...
  /**
   * Ensures the reservation date and time works with the restaurant's schedule.
   */
